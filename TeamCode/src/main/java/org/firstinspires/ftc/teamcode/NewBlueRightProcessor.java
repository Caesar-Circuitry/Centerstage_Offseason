...
public class NewBlueRightProcessor implements VisionProcessor, CameraStreamSource {
    ...
    public static double rightNW_X = 0.68;
    public static double rightNW_Y = 0.58;
    public static double rightSE_X = 0.95;
    public static double rightSE_Y = 0.92;
    ...
    public void init(int width, int height, CameraCalibration calibration) {
        ...
        */
        ...
        this.MIDDLE_RECTANGLE = new Rect(
                new Point(0 * width, .55 * height),
                new Point(0.45 * width, .8 * height)
        );
