...
@Config
@Autonomous(name = "Blue Back Park:Outside", group = "Blue")
public class blueBackOutside extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        trajectoryLeftPurple = drive.actionBuilder(drive.pose)
                .splineToLinearHeading(new Pose2d(31,34,Math.PI),Math.toRadians(270))
                .build();
