...
@Config
@Autonomous(name = "Blue Front Truss Park:DNR", group = "Blue")
public class blueFrontTrussOutside extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        trajectoryLeftYellowPlace = drive.actionBuilder(new Pose2d(16,57.5,Math.toRadians(180)))
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(49,38.5),0)
                .build();
        ...
        trajectoryMiddleYellowPlace = drive.actionBuilder(new Pose2d(16,57.5,Math.toRadians(180)))
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(49,35),0)
                .build();
        ...
        trajectoryLeftCloseOut = drive.actionBuilder(new Pose2d(49.5,38.5,Math.PI))
                .waitSeconds(1)
                .lineToX(45)
        ...
        trajectoryMiddleCloseOut = drive.actionBuilder(new Pose2d(49.5,32,Math.PI))
                ...
                .strafeToConstantHeading(new Vector2d(44,62))
                .build();
        trajectoryRightCloseOut = drive.actionBuilder(new Pose2d(49.5,23.5,Math.PI))
                .waitSeconds(1)
                .lineToX(45)
                .strafeToConstantHeading(new Vector2d(44,62))
                .build();
